...
const val ARTIST = "debeli%20precjednik"
const val API_METHOD_GET_SIMILAR = "artist.getsimilar&artist="
const val API_METHOD_GET_INFO = "artist.getinfo&artist="
const val API_BASE = "https://ws.audioscrobbler.com/2.0/?method="
...
interface DiscogApi {
    ...
    @GET(API_BASE + API_METHOD_GET_SIMILAR + ARTIST + "&api_key=" + KEY + "&format=json")
    fun fetchItems(): Call<List<ArtistItem>>
}
...
class ArtistFragmentAdapter(private val context: Context, /*private val artist: Artist*/private val artists: MutableList<Artist>) :
    RecyclerView.Adapter<ArtistFragmentAdapter.ViewHolder>() {
